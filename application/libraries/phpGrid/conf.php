...
if (stripos($_SERVER['SCRIPT_NAME'], 'apps/phpgrid-custom-crm')) {
    define('PHPGRID_DB_HOSTNAME', '192.168.1.200'); // database host name
    define('PHPGRID_DB_USERNAME', 'dimpe');     // database user name
    define('PHPGRID_DB_PASSWORD', 'D1mP3D3s4rr0ll0'); // database password
    define('PHPGRID_DB_NAME', 'dane_ecas_v2'); // database name
