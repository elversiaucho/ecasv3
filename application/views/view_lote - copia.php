  ...
  <div class="estilo_campos">
   	<?php 
		$attributes = array('class' => '', 'id' => 'form_lote' , 'method' => 'POST');
     	...
     	<h4>Por favor identificar y diligenciar las siguientes preguntas:</h4> 
        <br>
     <div class="row">
         <label class="col-sm-3" >En que colegio estas?</label>
     ...
     <div class="row">
        <label class="col-lg-4">Jornada:</label>
     ...
     <div class="row">
        <label class="col-lg-4">Grado:</label>
     ...
     <div class="row">
     	<label class="col-lg-4">Número de estudiantes matriculados en el curso:</label>
     	<input type="text" name="nro_ecurso" value = "<?php echo set_value('nro_ecurso');?>"/>
     	<p class="t_error"><?php echo strip_tags(form_error('nro_ecurso')); ?></p>
     </div>
     <div class="row">
     	<label class="col-lg-4">Número de estudiantes que asisten regularmente:</label>
     	<input type="text" name="nro_eregulares" value = "<?php echo set_value('nro_eregulares');?>"/>
     	<p class="t_error"><?php echo strip_tags(form_error('nro_eregulares')); ?></p>
     </div>
      <div class="row">
        <label class="col-lg-4">Número de estudiantes a encuestar:</label>
        <input type="text" name="nro_presentes" value = "<?php echo set_value('nro_presentes');?>"/>
        <p class="t_error"><?php echo strip_tags(form_error('nro_presentes')); ?></p>
     </div>
     <div class="row">
    <label class="col-sm-4">Sistema de recolección:</label>
    </div>
            <div class="row">
