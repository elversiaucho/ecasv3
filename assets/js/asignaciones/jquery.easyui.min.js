...
},beforePageText:"Página",afterPageText:"de {pages}",displayMsg:"Mostrando {from} al {to} de {total} registros",nav:{first:{iconCls:"pagination-first",handler:function(){
